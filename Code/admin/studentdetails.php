  ...
  <?php
     ...
     if(isset($_GET['page'])){
        if($_GET['page'] === 'studentdetails'){ 
            
            $counter = 0;          
            

            $query = "select fullname, photo, program, dateofbirth, gender, religion, category, mobile, email, fathername, fathermobile, mothername, mothermobile, permanentaddress, localguardian, guardianmobile, localaddress, note, bloodgroup, aadhaar, voterid, disableperson  from tbl_applicant where universityreg = '" . $_GET['ureg']."';";
                ...
                ?>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <li class="list-group-item">
                                    <b>Core</b> <a id="core" class="float-right">BCA</a>
                                </li>
                                </ul>
                                <?php
                                    if($_SESSION['$role'] === '1'){
                                        ...
                                        if(isset($_GET['action'])){
                                            if($_GET['action'] === "newapplication" || $_GET['action'] === "monitor"){
                                                ...
                                                echo '<a href="?action=reject&applicationid='.$_GET['applicationid'].'" class="btn btn-danger btn-block"><b>Waiting Application</b></a>';
                                            }
                                        }
                                    }
                                        ...
                                        if(isset($_GET['action'])){
                                            if($_GET['action'] === "newapplication"){
                                                ...
                                                echo '<a href="?action=reject&applicationid='.$_GET['applicationid'].'" class="btn btn-danger btn-block"><b>Awaiting Application</b></a>';
                                            }
                                                ...
                                                echo '<b>This application has been put in waiting list. But you can re-check it for approval. Pricipal will be notified.</b>';
                                                echo '<a href="?action=monitor&applicationid='.$_GET['applicationid'].'" class="btn btn-primary btn-block"><b>Send for Approval</b></a>'; //If clicked, send to principal for approval
                                        ...
                                        if(isset($_GET['action'])){
                                            if($_GET['action'] === "newapplication"){
                                                ...
                                                echo '<a href="?action=reject&applicationid='.$_GET['applicationid'].'" class="btn btn-danger btn-block"><b>Waiting List Application</b></a>';
                                            }
                                            else if($_GET['action'] === "monitor"){
                                                echo '<b>This application has been sent to the principal for further approval.</b>';
                                            }
                                            else if($_GET['action'] === "reject"){
                                                echo '<b>This application has been on hold in awaiting list.</b>';
                                            }                                        
                                        }
                                    }
                                        ...
                                        if(isset($_GET['action'])){
                                            if($_GET['action'] === "newapplication"){
                                                ...
                                                echo '<b>This application has been rejected.</b>';
                                            }
                                        }
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card-body table-responsive p-0" style="height: 515px;">
                                ...
                                <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                                $query = "select * from tbl_applicant_qualification where applicationid = '" . $_GET['ureg'] . "';";
                                                $result = $mysqli->query($query);
                                                $counter = 1;
                                                while($row=$result->fetch_row()){
                                                    echo '<tr>';
                                                    echo '<td>' . $counter++ .'</td>';
                                                    echo '<td><a href="" data-toggle="modal" data-target="#'.$row[1].'"><strong>'.$row[1].'</strong></a></td>';
                                                    ?>
                                                    <div class="modal fade" id="<?php echo $row[1];?>">
                                ...
                                <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                                $query = "select * from tbl_applicant_payment where applicationid = '" . $_GET['ureg'] . "' ORDER BY applicationid ASC;";
                                                $result = $mysqli->query($query);
                                                $counter = 1;
                                                while($row=$result->fetch_row()){
                                                    echo '<tr>';
                                ...
                                <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                                $query = "select bloodgroup, aadhaar, voterid, aadhaarscanned, aadhaarbackscanned, voteridscanned, voteridbackscanned from tbl_applicant where applicationid = '" . $_GET['ureg'] . "';";
                                                $result = $mysqli->query($query);
                                                $counter = 1;
                                                while($row=$result->fetch_row()){
                                                    echo '<tr>';
                        ...
                        <div class="modal-dialog modal-xl">
                            ...
                            <?php
                                $status = 'unpaid';
                                $query = "select status from tbl_applicant_payment where applicationid = '". $_GET['ureg']."';";
                                $result = $mysqli->query($query);
                                if($row = $result->fetch_row()){
                                    if($row[0] === 'paid'){
                                    $status = 'paid';
                                ...
                                fathername, fathermobile, mothername, mothermobile, permanentaddress, localguardian, guardianmobile, localaddress, photo, note, bloodgroup, aadhaar, voterid from tbl_applicant where universityreg = '". $_GET['ureg'] . "';";
                                $result = $mysqli->query($query);
                                $row = $result->fetch_row();
                            ?>
                                <div class="modal-body">
                                    ...
                                    ?>
                                    <h5 style="color:red";><strong>University Reg #:</strong> &emsp;<?php echo $_GET['ureg']; ?></h5> 
                                ...
                                <div class="card">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        <?php
                                            $query = "select examinationpassed, institute, board, yearofpassing, divisiongrade, percentage from tbl_applicant_qualification where applicationid = '". $_GET['ureg'] . "';";
                                            $result = $mysqli->query($query);
                                            $counter = 1;
                                            while($row = $result->fetch_row()){
                                                ?>
