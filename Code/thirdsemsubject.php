                ...
                <div class="col-md-12">
                    ...
                    <div id="card" class="card card-warning">
                        <div class="card-header">
                            <h3 id="card-title" class="card-title">Fill the University Roll No</h3>
                        </div>
                ...
                if($requestType == 'POST'){
                    if(isset($_POST['action'])){
                        if($_POST['action'] === "payfee"){
                            ...
                            $query = "SELECT * FROM `tbl_elective_subject` WHERE uroll = '" . $mysqli -> real_escape_string($_POST['urollno']) . "';"; 
                            $result = $mysqli->query($query);
							$row = $result->num_rows;
                            ...
                            if($row > 0){                                
                                //Already Made payment
                                 //Display Table
                                 $fullname = $program = $semester = $electiveone = $electivetwo = $electivethree = '';
                                 $row = $result->fetch_row();
                                 $electiveone = $row[1];
                                 $electivetwo = $row[2];
                                 $electivethree = $row[3];
                                             ...
                                             <div class="card-body">   
                                                <form action="" role="form" method="post" enctype="multipart/form-data">
                                                     ...
                                                     <div class="row">
                                                         <div class="col-sm-6">
                                                         <div class="form-group">
                                                             <label>Elective One</label>
                                                             <input type="text" name="semester" value="<?php echo $electiveone; ?>" class="form-control" readonly>
                                                         </div>
                                                         </div>
                                                         <div class="col-sm-6">
                                                         <div class="form-group">
                                                             <label>Elective Two</label>
                                                             <input type="text" name="coresubject" value="<?php echo $electivetwo; ?>" class="form-control" readonly>                                 
                                                         </div>
                                                         </div>
                                                     </div> 
                                                      ...
                                                      <div class="row">
                                                         <div class="col-sm-6">
                                                         <div class="form-group">
                                                             <label>Elective Three</label>
                                                             <input type="text" name="electivethree" value="<?php echo $electivethree; ?>" class="form-control" readonly>
                                                         </div>
                                                         </div>                                                         
                                                     </div> 
                                                    ...
                                                    <div class="card-body">  
                                                     ...
                                                     <div class="row">
                                                         ...
                                                         <div class="form-group">
                                                             ...
                                                             <input type="text" name="semester" value="3rd Sem" class="form-control" readonly>
                                                         </div>
                                                         </div>
                                                         <div class="col-sm-6">
                                                         <div class="form-group">
                                                             <label>Elective 1 Subject</label>
                                                             <select name="electiveone" class="form-control" required> 
                                                                <?php 
                                                                    if($program === 'B.Sc'){
                                                                        ...
                                                                        echo '<option value="Commerce" selected>Marketing</option>';                                                                        
                                                                    }
                                                                    else if($program === 'BCA'){
                                                                        echo '<option value="Computer Sc" selected>Conputer Application</option>';
                                                                    }
                                                                ?>
                                                             </select>                                   
                                                         </div>
                                                         ...
                                                         <div class="col-sm-6">
                                                         <div class="form-group">
                                                             <label>Elective 2 Subject</label>
                                                             <select name="electivetwo" class="form-control" required> 
                                                                <?php 
                                                                    if($program === 'B.Sc'){
                                                                        echo '<option value="Botany">Botany</option>';
                                                                        echo '<option value="Chemistry">Chemistry</option>';
                                                         ...
                                                         <div class="col-sm-6">
                                                         <div class="form-group">
                                                             <label>Elective 3 Subject</label>
                                                             <select name="electivethree" class="form-control" required> 
                                                                <?php 
                                                                    if($program === 'B.Sc'){
                                                                        echo '<option value="Botany">Botany</option>';
                                                                        echo '<option value="Chemistry">Chemistry</option>';
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">                                    
                                                                <div class="form-group">                                                                     
                                                                    <input type="hidden" name="action" value="updateelective">
                                                                    ...
                                                                    <?php 
                                                                        if($feeamount != 'Not Found'){
                                                                            ...
                                                                            //echo '<a href="registerunistudent.php" class="btn btn-primary"><i class="fas fa-save"></i>&nbsp;Save</a>'; 
                                                                            echo '<button type="submit" class="btn btn-success"><i class="fas fa-check-alt"></i>&nbsp;Submit</button>';                                                           
                                                                        }                                                                
                                                                    ?>  
                        ...
                        else if($_POST['action'] === "updateelective"){

                            //require 'config/dbconfig.php';
                            //$mysqli = new mysqli(DBHOST, DBUSER, DBPWD, DBNAME);  


                            $query = "update tbl_elective_subject set electiveone = '".$_POST['electiveone']."', electivetwo = '".$_POST['electivetwo']."', electivethree = '".$_POST['electivethree']."' where uroll = '" .$_POST['urollno']. "';";
                            ...
                            if($stmt->affected_rows > 0){
                                ...
                                $query = "insert into tbl_elective_subject values('" .$_POST['urollno']. "', '".$_POST['electiveone']."', '".$_POST['electivetwo']."', '".$_POST['electivethree']."');";
                                $stmt = $mysqli->prepare($query);   
                                $stmt->execute();
                                echo "<script>alert('Successfully Updated.');</script>";      
                            }
